...
namespace Лаб5
{
    ...
    {   
        ...
        static void Main()
        {
            ...
            string str7 = "", str8 = "";
            str6 = "Здесь нетstudent студентов";
            ...
            /*Zad 3
            string a = "Это 3 задание, Поможет показать, Реализацию функции, А именно split";
            functional(a);*/

            /*Zad 4
            StringBuilder a = new StringBuilder("Работа метода ");
            StringBuilder b = new StringBuilder("присоединение в начало");
            a.Append("Append");
            b.Insert(0, "Insert ");
            Console.WriteLine(a);
            Console.WriteLine(b);
            ...
            /*Zad 5
            StringBuilder a = new StringBuilder("Каков размер буфера??");
            StringBuilder b = new StringBuilder("Инфо о содержимом.");
